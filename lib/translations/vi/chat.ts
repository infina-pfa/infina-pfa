export const chatVi = {
  ...
  expenseTrackerDescription:
    "Theo dõi chi tiêu hàng ngày và thói quen chi tiêu của bạn",

  goalPlannerTitle: "Lập kế hoạch Mục tiêu Tài chính",
  goalPlannerDescription:
    "Đặt và theo dõi mục tiêu tài chính của bạn từng bước",
  ...
  spendingChartDescription:
    "Trực quan hóa các mô hình và xu hướng chi tiêu của bạn",
