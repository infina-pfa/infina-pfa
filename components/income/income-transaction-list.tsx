        ...
        {loading ? (
          ...
          incomes.map((income) => (
            <div
              ...
              className="flex flex-row justify-between items-start py-4 md:py-4 cursor-pointer hover:bg-[#F9FAFB] transition-colors duration-150 ease-in-out min-h-[56px] px-2 -mx-2 rounded-lg"
              tabIndex={0}
              role="button"
