...
import { useBudgetManagementSWR } from "@/hooks/swr";
...
export function BudgetDetailMessage({ onSendMessage }: BudgetDetailMessageProps) {
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span className="font-semibold text-gray-900">{formatVND(totalSpent)}</span>
          </div>
          
          <div className="flex justify-between text-sm">
            <span className="text-gray-600">Tổng ngân sách:</span>
            <span className="font-semibold text-gray-900">{formatVND(totalBudget)}</span>
          </div>
          ...
          <ProgressBar
            ...
            color={isOverBudget ? "#F44336" : spendingPercentage > 80 ? "#FFC107" : "#0055FF"}
            className="h-3 mt-2"
          />
        </div>
      </div>
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2 max-h-48 overflow-y-auto">
            {budgets.map((budget) => {
              ...
              return (
                <div key={budget.id} className="flex items-center space-x-3 p-3 rounded-lg hover:bg-gray-50">
                  <div 
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <ProgressBar
                      ...
                      color={isOverLimit ? "#F44336" : isWarning ? "#FFC107" : budget.color}
                      className="h-1.5"
                    />
                  </div>
                </div>
