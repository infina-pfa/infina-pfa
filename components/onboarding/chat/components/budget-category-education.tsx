...
import { CheckCircle, Circle, TrendingUp, Home, Zap, Star, AlertTriangle } from "lucide-react";
...
export default function BudgetCategoryEducation({ 
  ...
  const [isCompleted, setIsCompleted] = useState(!!component.response?.understood);
  ...
  const budgetCategories = [
    {
      ...
      description: t("emergencyFundPriorityDescription", { 
        ns: "budgeting", 
        defaultValue: "Your highest priority - this is your PYF amount for financial security" 
      }),
    ...
    },
    {
      ...
      rule: t("livingExpensesRule", { 
        ns: "budgeting", 
        defaultValue: "Allocate after emergency fund - covers necessities and plans" 
      })
    },
    {
      id: "free_to_spend",
      ...
      description: t("freeToSpendPriorityDescription", { 
        ns: "budgeting", 
        defaultValue: "Discretionary spending money for entertainment and wants" 
      }),
    ...
    try {
      ...
      const response = {
        ...
        userMessage: t("budgetCategoryEducationUserMessage", { 
          ns: "onboarding", 
          defaultValue: "I understand the 3-category priority system: Emergency Fund (Priority 1), Living Expenses (Priority 2), and Free to Spend (Priority 3). I'm ready to allocate my budget using this priority system." 
        }),
        learningContext: {
          ...
          keyLearnings: [
            t("keyLearning1", { ns: "onboarding", defaultValue: "Always prioritize your emergency fund - it's your financial safety net" }),
            t("keyLearning2", { ns: "onboarding", defaultValue: "Cover essential living expenses before discretionary spending" }),
            t("keyLearning3", { ns: "onboarding", defaultValue: "Free spending should never exceed 2x your emergency fund" })
          ]
        }
      };
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-[#6B7280]">
          {t("budgetCategoryEducationSubtitle", { 
            ns: "onboarding", 
            defaultValue: "Learn the 3-category priority system to manage your money effectively" 
          })}
        </p>
      </div>
      ...
      <div className="bg-[#F6F7F9] rounded-xl p-4 border border-[#E5E7EB]">
        ...
        <p className="text-sm text-[#4B5563] leading-relaxed">
          {t("prioritySystemDescription", { 
            ns: "onboarding", 
            defaultValue: "We allocate your income in order of priority: Emergency Fund first, then Living Expenses, and finally Free to Spend money." 
          })}
        </p>
      </div>
        ...
        <ul className="space-y-2 text-sm text-[#4B5563]">
          <li className="flex items-start space-x-2">
            ...
            <span>
              {t("keyLearning1", { 
                ns: "onboarding", 
                defaultValue: "Always prioritize your emergency fund - it's your financial safety net" 
              })}
            </span>
          </li>
          <li className="flex items-start space-x-2">
            ...
            <span>
              {t("keyLearning2", { 
                ns: "onboarding", 
                defaultValue: "Cover essential living expenses before discretionary spending" 
              })}
            </span>
          </li>
          <li className="flex items-start space-x-2">
            ...
            <span>
              {t("keyLearning3", { 
                ns: "onboarding", 
                defaultValue: "Free spending should never exceed 2x your emergency fund" 
              })}
            </span>
          </li>
        </ul>
      ...
      {!isCompleted && (
        ...
        >
          {isSubmitting 
            ...
            : t("continueToAllocation", { ns: "onboarding", defaultValue: "Continue to Budget Allocation" })
          }
        </Button>
      )}
